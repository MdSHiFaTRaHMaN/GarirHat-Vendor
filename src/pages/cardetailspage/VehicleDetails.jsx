...
import { FaCar, FaGasPump, FaCogs, FaKey, FaCheck, FaTimes } from "react-icons/fa";
...
const VehicleDetails = () => {
  ...
  const extras = ["8 times wheels", "all wheel drive", "alloy wheels", "parking assistance", "electric windows", "Electric side mirrors", "air conditioning"];
      ...
      <div>
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {extras.map((extra, index) => (
            <Tag key={index} color="green">{extra}</Tag>
          ))}
        </div>
      </div>
